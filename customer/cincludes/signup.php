            ...
            <div class="col-md-6 col-sm-12">
                <center>
                    ...
                    <div class="jumbotron jumbotron-fluid">
                        <div class="container">
                            <h1 style="padding-top:0%;margin-top:0%;">Login to online shopping</h1>
                            ...
                            <form action="kuvalida.php" method="post" style="margin-top:5%;" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4 col-md-4"><button type="submit" name="subpass" class="btn btn-success">Log
                                            in</button></div>
                                </div>
                        </div>
                        </form>
                        <div class="row" style="margin-top:10%;">
                            <div class="col-sm-12 col-md-12">
                                <p>Forgotten password<a href="" class="">click here</a></p>
                            </div>
                        </div>
                        <div class="row" style="margin-top:10%;">
                            <div class="col-sm-12 col-md-12">
                                <p>You have no acccount<a href="" class="btn btn-info">click here</a></p>
                            </div>
                        </div>
                    </div>
                </center>
