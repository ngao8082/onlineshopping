<div class="row bg-dark">
    <div class="col-sm-4 col-md-4 text-muted">
        ...
        <ul class="text-white">
            ...
            <li><a href="myaccount.php" class="text-muted">My account</a></li>
        ...
        <ul class="text-white">
            <li><?php
                       if (!isset($_SESSION['passwo'])) {
                         echo"<a class='text-muted' href='signup.php'>Login</a>";
                       }else {
                           echo"<a class='text-muted' href='signout.php'>Logout</a>";
                       }
                   ?>
            </li>
            <li><a href="../register.php" class="text-muted">Register</a></li>
            <li><a href="term.php" class="text-muted">Terms & condition</a></li>
        </ul>
    </div>
    <div class="col-sm-4 col-md-4 text-muted">
